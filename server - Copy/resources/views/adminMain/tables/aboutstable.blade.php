  ...
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        ...
        <li class="active"><a href="admin/tables/aboutstable">Menu About Table</a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/aboutstable" >Tables</a><a href="admin/tables/aboutstable" class="current">Menu About Table</a> </div>
    <h1>Table Menu About</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/aboutstable" method="POST" class="form-horizontal">
              ...
              <tbody>
               @foreach($about as $ab)
                <tr class="gradeA">
                  <td>{{$ab->id}}</td>
                  <td>{{$ab->image}}</td>
                  <td class="center"><a href="admin/tables/suaaboutstable/{{$ab->id}}">edit</a></td>
                </tr>
                @endforeach
              ...
              <tbody>
               @foreach($about as $ab)
                <tr class="gradeA">
                  ...
                  <td></td>
                  <td></td>
                  <td class="center"><a href="admin/tables/xoaaboutstable/{{$ab->id}}">delete</a></td>
                </tr>
                @endforeach
