    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/productstable" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">ID PRODUCT :</label>
              <div class="controls">
                <input type="text" class="span11" name="idproduct" placeholder="vd:Sản Phẩm Cuối Cùng có id SP015 thì sản phẩm tiếp theo là đặt tên là: SP016" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">TEN PRODUCT :</label>
              <div class="controls">
                <input type="text" class="span11" name="tenproduct" placeholder="" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Name PRODUCT :</label>
              <div class="controls">
                <input type="text"  class="span11" name="nameproduct"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct1 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct1"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct2 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct2"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct3 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct3"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct4 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct4"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct5 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct5"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct6 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct6"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PathProduct7 :</label>
              <div class="controls">
                <input type="text"  class="span11" name="pathproduct7"  placeholder=""  />
              </div>
            </div>
              ...
              <tbody>
               @foreach($products as $pr)
                <tr class="gradeA">
                  ...
                  <td><img src="{{$pr->pathproduct1}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct2}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct3}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct4}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct5}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct6}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct7}}" width="150" height="150"></td>
                  <td class="center"><a href="admin/tables/suaproductstable/{{$pr->idproduct}}">edit</a></td>
                </tr>
                @endforeach
              ...
              <tbody>
               @foreach($products as $pr)
                <tr class="gradeA">
                  ...
                  <td><img src="{{$pr->pathproduct6}}" width="150" height="150"></td>
                  <td><img src="{{$pr->pathproduct7}}" width="150" height="150"></td>
                  <td class="center"><a href="admin/tables/xoaproductstable/{{$pr->idproduct}}">DELETE</a></td>
                </tr>
                @endforeach
