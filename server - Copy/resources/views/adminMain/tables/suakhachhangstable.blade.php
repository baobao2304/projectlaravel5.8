    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>EDIT KHACH HANG</h5>
        </div>
        <div class="widget-content nopadding">
         <form action="admin/tables/suakhachhangstable/{{$khachhangstable->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">TEN USER :</label>
              <div class="controls">
                <input type="text" class="span11" name="tenuser" value="{{$khachhangstable->tenuser}}" placeholder="" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">NUMBERPHONE :</label>
              <div class="controls">
                <input type="text" class="span11" name="numberphone" value="{{$khachhangstable->numberphone}}" placeholder="" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">MAIL :</label>
              <div class="controls">
                <input type="text" class="span11" name="mail" value="{{$khachhangstable->mail}}" placeholder="" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ADD ADMIN :</label>
              <div class="controls">
                <input type="text" class="span11" name="addadmin" value="{{$khachhangstable->addadmin}}" placeholder="" />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/khachhangstable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
