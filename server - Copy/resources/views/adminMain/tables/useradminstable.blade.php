    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/useradminstable" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">USER ID :</label>
              <div class="controls">
                <input type="text" class="span11" name="name" placeholder="vd:sale ten taikhoan" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" name="addadmin"/>
              </div>
            </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               @foreach($useradmin as $userad)
                <tr class="gradeA">
                  <td>{{$userad->name}}</td>
                  <td>{{$userad->email}}</td>
                  <td>{{$userad->pass}}</td>
                  <td>{{$userad->addadmin}}</td>
                  <td class="center"><a href="admin/tables/suauseradminstable/{{$userad->id}}">edit</a></td>
                </tr>
                @endforeach
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeA">
                  ...
                  <td>{{$userad->pass}}</td>
                  <td>{{$userad->addadmin}}</td>
                  <td class="center"><a href="admin/tables/xoauseradminstable/{{$userad->id}}">delete</a></td>
                </tr>
                @endforeach
