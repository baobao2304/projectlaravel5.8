...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/skillfilestable" >Tables</a><a href="admin/tables/skillfilestable" class="current">SkillFile Table</a> </div>
    <h1>Table Skill File</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>EDIT SKILLFILE</h5>
        </div>
        <div class="widget-content nopadding">
      
          <form action="admin/tables/suaskillfilestable/{{$skillfile->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">IDFRUIT :</label>
              <div class="controls">
                <input type="text" class="span11" name="idfruit" value="{{$skillfile->idfruit}}" placeholder="" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PATH IMAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="image" value="{{$skillfile->image}}" placeholder="" />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/skillfilestable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
