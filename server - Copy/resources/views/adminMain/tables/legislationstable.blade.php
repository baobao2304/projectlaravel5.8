...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/legislationstable" >Tables</a><a href="admin/tables/legislationstable" class="current">Menu Legislation Table</a> </div>
    <h1>Table Menu Legislation</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>ADD Legislation</h5>
        </div>
        <div class="widget-content nopadding">
        
          <form action="admin/tables/legislationstable" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">Path IMAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="image" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">TYPE :</label>
              <div class="controls">
                <input type="text" class="span11" name="type" placeholder="vd:nội dung chính của văn bản pháp luật" />
              </div>
            </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               @foreach($legislationstable as $lgla)
                <tr class="gradeA">
                  <td>{{$lgla->image}}</td>
                  <td>{{$lgla->type}}</td>
                  <td>{{$lgla->created_at}}</td>
                  <td>{{$lgla->updated_at}}</td>
                  <td class="center"><a href="admin/tables/sualegislationstable/{{$lgla->id}}">edit</a></td>
                </tr>
                @endforeach
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeA">
                  ...
                  <td>{{$lgla->created_at}}</td>
                  <td>{{$lgla->updated_at}}</td>
                  <td class="center"><a href="admin/tables/xoalegislationstable/{{$lgla->id}}">delete</a></td>
                </tr>
                @endforeach
