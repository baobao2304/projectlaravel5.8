...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        <li class="active"><a href="admin/tables/productclassificationstable">Product Classification Table</a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/productclassificationstable" >Tables</a><a href="admin/tables/productclassificationstable" class="current">Product Classification</a> </div>
    <h1>Table Product Classificaion</h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>ADD Item Product Classificaion</h5>
        </div>
        <div class="widget-content nopadding">
        
          <form action="admin/tables/productclassificationstable" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">ID FRUIT :</label>
              <div class="controls">
                <input type="text" class="span11" name="idfruit" placeholder="vd:trái sầu riêng đặt tên là: IDSAURIENG" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ID STAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="idstage" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">TEN PRODUCT :</label>
              <div class="controls">
                <input type="text"  class="span11" name="idproduct"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               @foreach($productclassification as $prtclssication)
                <tr class="gradeA">
                  <td>{{$prtclssication->id}}</td>
                  <td>{{$prtclssication->idfruit}}</td>
                  <td>{{$prtclssication->idstage}}</td>
                  <td>{{$prtclssication->idproduct}}</td>
                  <td class="center"><a href="admin/tables/suaproductclassificationstable/{{$prtclssication->id}}">edit</a></td>
                </tr>
                @endforeach
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <td>{{$prtclssication->id}}</td>
                  ...
                  <td>{{$prtclssication->idstage}}</td>
                  <td>{{$prtclssication->idproduct}}</td>
                  <td class="center"><a href="admin/tables/xoaproductclassificationstable/{{$prtclssication->id}}">delete</a></td>
                </tr>
                @endforeach
