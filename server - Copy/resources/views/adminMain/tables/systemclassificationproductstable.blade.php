    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>ADD Menu System Classification Product</h5>
        </div>
        <div class="widget-content nopadding">
        
          <form action="admin/tables/systemclassificationproductstable" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">Province :</label>
              <div class="controls">
                <input type="text" class="span11" name="province" placeholder="Khu vực bán" />
              </div>
            </div>
            <!-- <div class="control-group">
              <label class="control-label">Nước :</label>
              <div class="controls">
                <input type="text" class="span11" name="nuoc" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tỉnh :</label>
              <div class="controls">
                <input type="text"  class="span11" name="tinh"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">City :</label>
              <div class="controls">
                <input type="text"  class="span11" name="city"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div> -->
            <div class="control-group">
              <label class="control-label">Branchadress :</label>
              <div class="controls">
                <input type="text"  class="span11" name="branchadress"  placeholder="Địa chỉ "  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">sdt :</label>
              <div class="controls">
                <input type="text"  class="span11" name="sdt" />
              </div>
            </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
               @foreach($systemclassificationproduct as $sysclsprt)
                <tr class="gradeA">
                <td>{{$sysclsprt->province}}</td>
                  <!-- <td>{{$sysclsprt->nuoc}}</td>
                  <td>{{$sysclsprt->tinh}}</td>
                  <td>{{$sysclsprt->city}}</td> -->
                  <td>{{$sysclsprt->branchadress}}</td>
                  <td>{{$sysclsprt->sdt}}</td>
                  <td class="center"><a href="admin/tables/suasystemclassificationproductstable/{{$sysclsprt->id}}">edit</a></td>
                </tr>
                @endforeach
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeA">
                  ...
                  <td>{{$sysclsprt->branchadress}}</td>
                  <td>{{$sysclsprt->sdt}}</td>
                  <td class="center"><a href="admin/tables/xoasystemclassificationproductstable/{{$sysclsprt->id}}">delete</a></td>
                </tr>
                @endforeach
