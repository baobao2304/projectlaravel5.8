...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/aboutstable" >Tables</a><a href="admin/tables/aboutstable" class="current">About Table</a> </div>
    <h1>Table About</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/suaaboutstable/{{$about->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">PATH IMAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="image" value="{{$about->image}}" placeholder="" />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/aboutstable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
