  ...
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        ...
        <li class="active"><a href="admin/tables/legislationstable">Menu Legislation Table</a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/legislationstable" >Tables</a><a href="admin/tables/legislationstable" class="current">Legislation Table</a> </div>
    <h1>Table Legislation</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>EDIT Legislation</h5>
        </div>
        <div class="widget-content nopadding">
      
          <form action="admin/tables/sualegislationstable/{{$legislationstable->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">Path IMAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="image" value="{{$legislationstable->image}}" placeholder="vd:trái sầu riêng đặt tên là: IDSAURIENG" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">TYPE :</label>
              <div class="controls">
                <input type="text" class="span11" name="type" value="{{$legislationstable->type}}" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng" />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/legislationstable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
