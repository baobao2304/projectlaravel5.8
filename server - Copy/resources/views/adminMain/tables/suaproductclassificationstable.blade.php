...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/productclassificationstable" >Tables</a><a href="admin/tables/productclassificationstable" class="current">Product Classification Table</a> </div>
    <h1>Table Fruit</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/suaproductclassificationstable/{{$productclassification->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">ID FRUIT :</label>
              <div class="controls">
                <input type="text" class="span11" name="idfruit" value="{{$productclassification->idfruit}}" placeholder="vd:trái sầu riêng đặt tên là: IDSAURIENG" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ID STAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="idstage" value="{{$productclassification->idstage}}" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ID PRODUCT :</label>
              <div class="controls">
                <input type="text"  class="span11" name="idproduct" value="{{$productclassification->idproduct}}"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/productclassificationstable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
