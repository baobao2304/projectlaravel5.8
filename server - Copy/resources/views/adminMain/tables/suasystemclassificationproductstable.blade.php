  ...
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        ...
        <li  class="active"><a href="admin/tables/systemclassificationproductstable">Menu System Classification Product Table</a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/systemclassificationproductstable" >Tables</a><a href="admin/tables/systemclassificationproductstable" class="current">Menu System Classification Product Table</a> </div>
    <h1>Table Menu System Classification Product</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>EDIT Menu System Classification Product</h5>
        </div>
        <div class="widget-content nopadding">
      
          <form action="admin/tables/suasystemclassificationproductstable/{{$systemclassificationproduct->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">Province :</label>
              <div class="controls">
                <input type="text" class="span11" name="province" value="{{$systemclassificationproduct->province}}" placeholder="vd:trái sầu riêng đặt tên là: IDSAURIENG" />
              </div>
            </div>
            <!-- <div class="control-group">
              <label class="control-label">Nước :</label>
              <div class="controls">
                <input type="text" class="span11" name="nuoc" value="{{$systemclassificationproduct->nuoc}}" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tỉnh :</label>
              <div class="controls">
                <input type="text"  class="span11" name="tinh" value="{{$systemclassificationproduct->tinh}}"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">City :</label>
              <div class="controls">
                <input type="text"  class="span11" name="city" value="{{$systemclassificationproduct->city}}"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div> -->
            <div class="control-group">
              <label class="control-label">Branchadress :</label>
              <div class="controls">
                <input type="text"  class="span11" name="branchadress" value="{{$systemclassificationproduct->branchadress}}"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">sdt :</label>
              <div class="controls">
                <input type="text"  class="span11" name="sdt" value="{{$systemclassificationproduct->sdt}}"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/systemclassificationproductstable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
