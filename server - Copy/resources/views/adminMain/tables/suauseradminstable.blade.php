  ...
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        ...
        <li  class="active"><a href="admin/tables/useradminstable">User Admin Table</a></li>
      </ul>
    </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/useradminstable" >Tables</a><a href="admin/tables/useradminstable" class="current"> User Admin Table</a> </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>EDIT USERADMIN</h5>
        </div>
        <div class="widget-content nopadding">
      
          <form action="admin/tables/suauseradminstable/{{$useradmin->id}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">User ID :</label>
              <div class="controls">
                <input type="text" class="span11" name="name" value="{{$useradmin->name}}" placeholder="ten cua user" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PASS :</label>
              <div class="controls">
                <input type="text" class="span11" name="password" value="{{$useradmin->password}}" placeholder="vd:password" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">MAIL :</label>
              <div class="controls">
                <input type="text"  class="span11" name="email" value="{{$useradmin->email}}"  placeholder="vd:email"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ADDADMIN :</label>
              <div class="controls">
                <input type="text"  class="span11" name="addadmin" value="{{$useradmin->addadmin}}"  placeholder="quyen cua admin"  />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/useradminstable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
