    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/fruitstable" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="tenfruit" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Name Fruit :</label>
              <div class="controls">
                <input type="text"  class="span11" name="namefruit"  placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
              ...
              <tbody>
               @foreach($fruits as $fr)
                <tr class="gradeA">
                  ...
                  <td>{{$fr->tenfruit}}</td>
                  <td>{{$fr->namefruit}}</td>
                  <td class="center"><a href="admin/tables/suafruitstable/{{$fr->idfruit}}">edit</a></td>
                </tr>
                @endforeach
              ...
              <tbody>
               @foreach($fruits as $fr)
                <tr class="gradeA">
                  ...
                  <td>{{$fr->tenfruit}}</td>
                  <td>{{$fr->namefruit}}</td>
                  <td class="center"><a href="admin/tables/xoafruitstable/{{$fr->idfruit}}">delete</a></td>
                </tr>
                @endforeach
