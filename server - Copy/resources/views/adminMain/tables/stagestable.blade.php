    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/stagestable" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="idstage" placeholder="vd:Giai đoạn 1 thì idstage là : 1" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">TEN STAGE :</label>
              <div class="controls">
                <input type="text"  class="span11" name="tenstage"  placeholder=""  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">NAME STAGE :</label>
              <div class="controls">
                <input type="text"  class="span11" name="namestage"  placeholder="Tên tiếng anh của giai đoạn"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">MO TA :</label>
              <div class="controls">
                <input type="text"  class="span11" name="mota"  placeholder="vd:có cũng được không có cũng được "  />
              </div>
            </div>
              ...
              <tbody>
               @foreach($stage as $st)
                <tr class="gradeA">
                  ...
                  <td>{{$st->tenstage}}</td>
                  <td>{{$st->namestage}}</td>
                  <td class="center"><a href="admin/tables/suastagestable/{{$st->ids}}">edit</a></td>
                </tr>
                @endforeach
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeA">
                  ...
                  <td>{{$st->namestage}}</td>
                  <td>{{$st->mota}}</td>
                  <td class="center"><a href="admin/tables/xoastagestable/{{$st->ids}}">delete</a></td>
                </tr>
                @endforeach
