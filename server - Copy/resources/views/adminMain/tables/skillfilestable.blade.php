  ...
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        ...
        <li  class="active"><a href="admin/tables/skillfilestable">Menu Skill File Table</a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/skillfilestable" >Tables</a><a href="admin/tables/skillfilestable" class="current">Menu SkillFile Table</a> </div>
    <h1>Table Menu Skill File</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>ADD Skill File</h5>
        </div>
        <div class="widget-content nopadding">
        
          <form action="admin/tables/skillfilestable" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">ID FRUIT :</label>
              <div class="controls">
                <input type="text" class="span11" name="idfruit" placeholder="vd:Sản Phẩm Cuối Cùng có id SP015 thì sản phẩm tiếp theo là đặt tên là: SP016" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">PATH IMAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="image" placeholder="" />
              </div>
            </div>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              @foreach($skillfiles as $skillfile)
                <tr class="gradeA">
                  <td>{{$skillfile->idfruit}}</td>
                  <td>{{$skillfile->image}}</td>
                  <td>{{$skillfile->created_at}}</td>
                  <td>{{$skillfile->updated_at}}</td>
                  <td class="center"><a href="admin/tables/suaskillfilestable/{{$skillfile->id}}">edit
                  </a></td>
                </tr>
                @endforeach
            ...
            <table class="table table-bordered data-table">
              ...
              @foreach($skillfiles as $skillfile)
                <tr class="gradeA">
                  ...
                  <td>{{$skillfile->created_at}}</td>
                  <td>{{$skillfile->updated_at}}</td>
                  <td class="center"><a href="admin/tables/xoaskillfilestable/{{$skillfile->id}}">delete
                  </a></td>
                </tr>
                @endforeach 
              </tbody>
