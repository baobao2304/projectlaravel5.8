  ...
  <ul>
    ...
    <li class="active submenu"><a href="admin/home/dashboard"><i class="icon icon-th"></i> <span>Tables</span></a>
      <ul>
        ...
        <li class="active"><a href="admin/tables/stagestable">Stage Table</a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin/home/dashboard" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="admin/tables/stagestable" >Tables</a><a href="admin/tables/stagestable" class="current">Stage Table</a> </div>
    <h1>Table Stage</h1>
    </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="admin/tables/suastagestable/{{$stage->ids}}" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}"  />
            <div class="control-group">
              <label class="control-label">ID FRUIT :</label>
              <div class="controls">
                <input type="text" class="span11" name="idfruit" value="{{$stage->idfruit}}" placeholder="vd:trái sầu riêng đặt tên là: IDSAURIENG" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">ID STAGE :</label>
              <div class="controls">
                <input type="text" class="span11" name="idstage" value="{{$stage->idstage}}" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">TEN STAGE :</label>
              <div class="controls">
                <input type="text"  class="span11" name="tenstage"  value="{{$stage->tenstage}}" placeholder="vd:trái sầu riêng đặt tên là : Sản Phẩm Cho Sầu Riêng"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">NAME STAGE :</label>
              <div class="controls">
                <input type="text"  class="span11" name="namestage" value="{{$stage->namestage}}" placeholder="vd:trái sầu riêng đặt tên là : Product For Grapefruit"  />
              </div>
            </div>
            <div class="form-actions">
              <button type="submit" class="btn btn-success" ><a href="admin/tables/stagestable" style="color:white">Save</a></button>
            </div>
          </form>
        </div>
      </div>
